    ...
    return html`
      ...
      <form novalidate>
        <div>
          ...
          <input type="name" autofocus="autofocus" required id="name" name="name">
        ...
        <div>
          ...
          <div class="invalid-feedback">Erneute Passworteingabe ist erforderlich und muss mit der ersten Passworteingabe übereinstimmen</div>
        </div>
