...
const componentCSS = require('./svg-icon.component.scss');

/*
Created by Marius Bongarts on 26.03.2019.
This custom element is used to create feather svg icons.
Icons can be added: https://feathericons.com/
*/
